...
<div class="card">
	...
	<h5 class=" mb-0 text-gray-800 pl-3">{{ __('Add New  WithDraw Method') }} <a class="btn btn-primary btn-rounded btn-sm" href="{{route('admin-withdraw-method-index')}}"><i class="fas fa-arrow-left"></i> {{ __('Back') }}</a></h5>
	<ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">{{ __('Dashboard') }}</a></li>
        <li class="breadcrumb-item"><a href="javascript:;">{{ __('Manage Customers') }}</a></li>
        <li class="breadcrumb-item"><a href="{{ route('admin-withdraw-method-create') }}">{{ __('Add New WithDraw Method') }}</a></li>
	</ol>
	</div>
</div>
