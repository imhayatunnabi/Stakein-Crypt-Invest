...
@section('content')
  <div class="card">
    ...
    <h5 class=" mb-0 text-gray-800 pl-3">{{ __('Edit Language') }} <a class="btn btn-primary btn-rounded btn-sm" href="{{route('admin.tlang.index')}}"><i class="fas fa-arrow-left"></i> {{ __('Back') }}</a></h5>
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="{{route('admin.tlang.edit',$data->id)}}">{{ __('Edit Language') }}</a></li>
    </ol>
    </div>
  </div>
    ...
    <div class="col-lg-12">
      ...
      <div class="card mb-4">
        ...
        <div class="card-body">
          ...
          <form class="geniusform" action="{{route('admin.tlang.update',$data->id)}}" method="POST" enctype="multipart/form-data">
            {{csrf_field()}}
