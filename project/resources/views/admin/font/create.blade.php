...
<div class="card">
    <div class="d-sm-flex align-items-center justify-content-between">
      <h5 class=" mb-0 text-gray-800 pl-3">{{ __('Add Font') }} <a class="btn btn-primary btn-rounded btn-sm" href="{{route('admin.font.index')}}"><i class="fas fa-arrow-left"></i> {{ __('Back') }}</a></h5>
      <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item"><a href="{{route('admin.font.create')}}">{{ __('Add Font') }}</a></li>
      </ol>
    </div>
</div>
