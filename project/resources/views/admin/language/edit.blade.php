...
<div class="card">
    ...
    <h5 class=" mb-0 text-gray-800 pl-3">{{ __('Edit Language') }} <a class="btn btn-primary btn-rounded btn-sm" href="{{route('admin.lang.index')}}"><i class="fas fa-arrow-left"></i> {{ __('Back') }}</a></h5>
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="{{route('admin.lang.edit',$data->id)}}">{{ __('Edit Language') }}</a></li>
    </ol>
    </div>
</div>
