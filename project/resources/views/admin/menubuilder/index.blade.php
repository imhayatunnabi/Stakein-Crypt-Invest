            ...
            <div class="row menu-builder">
               <div class="col-lg-12">
                  <ul class="list-group">
                     ...
                     <li class="list-group-item d-flex justify-content-between">
                        <span class="menu-items">{{ __('Plan') }}</span>
                        <a data-title="{{ __('Plan') }}" data-dropdown="no" data-href="/pricing-plan" data-target="self" class="btn btn-primary btn-sm btn-rounded addToMenu" href="javascript:;">{{ __('Add To Menu') }}</a>
                     </li>
                     ...
                     <li class="list-group-item d-flex justify-content-between">
                        ...
                        <a data-title="{{ __('Contact') }}" data-dropdown="no" data-href="/contact" data-target="self" class="btn btn-primary btn-sm btn-rounded addToMenu" href="javascript:;">{{ __('Add To Menu') }}</a>
                     </li>
