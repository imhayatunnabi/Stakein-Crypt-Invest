...
@if(Auth::guard('admin')->user()->role_id != 0)
  ...
  @if(Auth::guard('admin')->user()->sectionCheck('Invests'))
  <li class="nav-item">
  ...
  @if(Auth::guard('admin')->user()->sectionCheck('Manage Plans'))
  <li class="nav-item">
  ...
  @if(Auth::guard('admin')->user()->sectionCheck('Homepage Setting'))
  <li class="nav-item">
  ...
  @if(Auth::guard('admin')->user()->sectionCheck('Language Setting'))
  <li class="nav-item">
